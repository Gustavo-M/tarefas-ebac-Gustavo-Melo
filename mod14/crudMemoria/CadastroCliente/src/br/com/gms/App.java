...
import br.com.gm.dao.ClienteMapDAO;
import br.com.gm.dao.IClienteDAO;
import br.com.gm.domain.Cliente;
...
public class App {
	...
	public static void main(String[] args) {
		...
		String opcao = JOptionPane.showInputDialog(null, "Digite 1 para cadastro, "
				+ "2 para consultar, 3 para exclusão, "
		...
		while(!isOpcaoValida(opcao)){
			...
			opcao = JOptionPane.showInputDialog(null, "Opção inválida digite 1 para cadastro, 2 para consulta, "
					+ "3 para cadastro, 4 para alterar,"
					+ " ou 5 para sair", "Green dinner", JOptionPane.INFORMATION_MESSAGE);
		}
		...
		while(isOpcaoValida(opcao)) {
			if(isOpcaoSair(opcao)) {
				...
				String dados = JOptionPane.showInputDialog(null, "Digite os dados separados por vírgula,"
						+ "conforme exemplo: Nome, CPF, tel, end, número, cidade,estado", "Cadastro", JOptionPane.INFORMATION_MESSAGE);
				cadastrar(dados);
	...
	private static void atualizar(String dados) {
		String[] dadosSepVirg = dados.split(",");
		Cliente cliente = new Cliente(dadosSepVirg[0],dadosSepVirg[1],dadosSepVirg[2],dadosSepVirg[3],dadosSepVirg[4],dadosSepVirg[5],dadosSepVirg[6]);
	...
	private static void sair() {
		...
		JOptionPane.showMessageDialog(null, "Clientes cadastrados: ", clienteCadastrados, 0);
		System.exit(0);
